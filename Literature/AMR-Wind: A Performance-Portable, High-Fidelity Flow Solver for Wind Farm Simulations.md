...
, aligned in the 𝑥
-direction. A specified cooling rate of 0.25 K/h
is imposed at the 𝑧
-bottom boundary. Periodic boundary conditions are imposed in the 𝑥
and 𝑦
directions. Monin–Obukhov similarity theory is used for the velocity at the 𝑧
-bottom boundary. The domain spatial size is 400 m ×400 m ×400 m
. We compare our results to those presented in [106], which featured cases ranged from Δ⁢𝑥 =Δ⁢𝑦 =3 m
and Δ⁢𝑧 =2 m
to Δ⁢𝑥 =Δ⁢𝑦 =0.56 m
and Δ⁢𝑧 =0.39 m
. The AMR-Wind simulations used Δ⁢𝑥 =Δ⁢𝑦 =Δ⁢𝑧 =0.781 m
(512 ×512 ×512

cells). The turbulence model used for these simulations is the constant-coefficient Smagorinsky model [48].
